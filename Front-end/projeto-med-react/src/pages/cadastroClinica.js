...
class cadastroClinica extends Component{
    constructor(props){
        super(props);
        this.state = {
            nome : '', 
        ...
        return(
            <section>
                ...
                <img src={cadastros} alt=""/>
                    ...
                    <form onSubmit={this.novoMedico} className="inputs-cadastro coluna ali spa">
                        
                        <h1>Novo Médico</h1>

                        <input className="input" name="nome" value={this.state.nome} onChange={this.atualizaState} type="text" placeholder="Nome"/>
                        <input className="input" name= "crm" value={this.state.crm} onChange={this.atualizaState} type="text" placeholder="CRM"/>
